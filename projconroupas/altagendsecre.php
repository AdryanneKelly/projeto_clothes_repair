...
<head>
    ...
    <title>Clothes Repair | Alterar Agendamento de Consertos</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        <a href="altagendsecre.php"><i class="glyphicon glyphicon-pencil"></i> <span class="nav-label">Alterar Agendamento de Conserto</span></a>
                    </li>
                </ul>
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-12">
                    <h2>Alterar Agendamento de Consertos</h2>
                </div>
            </div>
            <div class="ibox-content">
                ...
                ?>
                    <form method="post" action="validaaltagend.php?id=<?php echo $resultado['id'] ?>">
                        <div class="form-group  row"><label class="col-sm-12 col-form-label">ID</label>

                            <div class="col-sm-1"><input type="text" class="form-control" disabled="" value="<?php echo $resultado['id'] ?>" name="id"></div>
                        </div>
                        <div class="form-group  row"><label class="col-sm-2 col-form-label">Nome do Cliente</label>
                            <div class="col-sm-11"><input class="form-control m-b" type="text" name="nomecliente" value="<?php echo $resultado['nomecliente'] ?>">

                            </div>
                        </div>

                        <div class="form-group  row"><label class="col-sm-2 col-form-label">Serviço Desejado</label>
                            <div class="col-sm-11"><input type="text" class="form-control m-b" name="servicodesejado" value="<?php echo $resultado['servicodesejado'] ?>">


                            </div>
                        </div>

                        <div class="form-group row"><label class="col-sm-1 col-form-label">Inicio </label>
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-md-5"><input type="date" value="<?php echo $resultado['datainicio'] ?>" class="form-control" placeholder="Data de Inicio" name="datainicio"></div>
                                    <div class="col-md-1"><label class="col-md-5 col-form-label">Entrega </label></div>
                                    <div class="col-md-6"><input type="date" class="form-control" value="<?php echo $resultado['dataentrega'] ?>" placeholder="Data de Entrega" name="dataentrega"></div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row"><label class="col-sm-1 col-form-label">Preço </label>
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-md-5"><input type="text" class="form-control" placeholder="R$" value="<?php echo $resultado['preco'] ?>" name="preco"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <input type="submit" name="" class="btn btn-block btn-primary compose-mail col-md-10" value="Alterar Agendamento">
                        </div>
                    <?php
                }
                    ?>
