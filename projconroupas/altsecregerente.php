...
<head>
    ...
    <title>Clothes Repair | Alteração de Secretária</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        <a href="altsecregerente.php"><i class="glyphicon glyphicon-pencil"></i> <span class="nav-label">Alterar Secretária</span></a>
                    </li>
                </ul>
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="ibox-content">
                ...
                ?>
                    <form method="post" action="validaaltsecre.php?id=<?php echo $resultado['id'] ?>">
                        <div class="form-group  row"><label class="col-sm-1 col-form-label">ID</label>

                            <div class="col-sm-2"><input type="text" class="form-control" disabled="" name="id" value="<?php echo $resultado['id'] ?>"></div>

                        </div>
                        <div class="form-group  row"><label class="col-sm-1 col-form-label">Nome </label>

                            <div class="col-sm-10"><input type="text" class="form-control" name="nome" value="<?php echo $resultado['nome'] ?>"></div>
                        </div>
                        <div class="form-group row"><label class="col-sm-1 col-form-label">Login </label>
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-md-5"><input type="text" class="form-control" name="login" value="<?php echo $resultado['login'] ?>"></div>
                                    <div class="col-md-1"><label class="col-md-5 col-form-label">Senha </label></div>
                                    <div class="col-md-6"><input type="password" class="form-control" name="senha" value="<?php echo $resultado['senha'] ?>"></div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row"><label class="col-sm-1 col-form-label">Telefone </label>
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-md-5"><input type="text" class="form-control" name="telefone" value="<?php echo $resultado['telefone'] ?>"></div>
                                    <div class="col-md-1"><label class="col-md-5 col-form-label">CPF </label></div>
                                    <div class="col-md-6"><input type="text" class="form-control" name="cpf" value="<?php echo $resultado['cpf'] ?>"></div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group  row"><label class="col-sm-1 col-form-label">Endereço </label>

                            <div class="col-sm-10"><input type="text" class="form-control" name="endereco" value="<?php echo $resultado['endereco'] ?>"></div>
                        </div>
                        <div class="form-group  row"><label class="col-sm-1 col-form-label">Email </label>

                            <div class="col-sm-10"><input type="text" class="form-control" name="email" value="<?php echo $resultado['email'] ?>"></div>
                        </div>
                        <div class="col-sm-4">
