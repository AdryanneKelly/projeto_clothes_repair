...
<head>
    ...
    <title>Clothes Repair | Agendar Consertos</title>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-12">
                    <h2>Agendar Consertos</h2>
                </div>
            </div>
        <div class="ibox-content">
            <form method="post" action="validaagendamento.php">
                <div class="form-group  row"><label class="col-sm-2 col-form-label">Nome do Cliente</label>
                    <div class="col-sm-11"><input type="text" class="form-control m-b" name="nomecliente">
                        
                    </div>
                </div>
                
                <div class="form-group  row"><label class="col-sm-2 col-form-label">Serviço Desejado</label>
                    <div class="col-sm-11"><input type="text" class="form-control m-b" name="servicodesejado">
                ...
                <div class="form-group row"><label class="col-sm-1 col-form-label">Inicio </label>
                    <div class="col-sm-10">
                        <div class="row">
                            <div class="col-md-5"><input type="date" class="form-control" placeholder="Data de Inicio" name="datainicio"></div>
                            <div class="col-md-1"><label class="col-md-5 col-form-label">Entrega </label></div>
                            <div class="col-md-6"><input type="date" class="form-control" placeholder="Data de Entrega" name="dataentrega"></div>
                        </div>
                    </div>
                </div>
                <div class="form-group row"><label class="col-sm-1 col-form-label">Preço </label>
                    <div class="col-sm-10">
                        <div class="row">
                            <div class="col-md-5"><input type="text" class="form-control" placeholder="R$" name="preco"></div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <input type="submit" name="" class="btn btn-block btn-primary compose-mail col-md-10" value="Marcar Agendamento">
                </div>
            </form>
        </div>
        <div class="footer">
