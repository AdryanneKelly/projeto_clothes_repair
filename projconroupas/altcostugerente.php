...
if (isset($_POST['submit'])) {
    $id = $_GET['id'];
    $sql = "SELECT * FROM `costureira` WHERE id='$id'";
...
<head>
    ...
    <title>Clothes Repair | Alteração de Costureira</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        <a href="altcostugerente.php"><i class="glyphicon glyphicon-pencil"></i><span class="nav-label">Alterar Costureira</span> </a>
                    </li>
                </ul>
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="ibox-content">
                ...
                ?>
                    <form method="post" action="validaaltcostu.php?id=<?php echo $resultado['id'] ?>">
