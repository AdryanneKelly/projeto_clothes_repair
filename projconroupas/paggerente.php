...
<head>
    ...
    <title>Clothes Repair | Home Gerente</title>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="ibox">
                        ...
                        <?php 
                            include('conexao.php');
                            $sql = $conexao->query("SELECT SUM(preco) AS orcamento FROM agendamento WHERE status = 'concluido'");
                            $resultado = mysqli_fetch_assoc($sql);
                            echo "<h3>"."R$".$resultado['orcamento']."</h3>";
                        ?>
                        </div>
                        </div>
                    </div>
