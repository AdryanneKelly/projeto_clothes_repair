...
<head>
    ...
    <title>Clothes Repair | Consulta de Serviços</title>
            ...
            <div class="row">
                ...
                <div class="ibox ">
                    ...
                    foreach ($result as $linha) {
                     ...
                     ?>
                      <tr class="gradeX">
                        ...
                        <td><a href="altservsecre.php?id=<?php echo $linha['id']; ?>" class="btn btn-info">Alterar</a></td>
                    ...
                    <div class="modal fade" id="modalExemplo<?php echo $linha['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <a href="validaexclserv.php?id=<?php echo $linha['id']; ?>"><button type="button" class="btn btn-primary">Excluir</button></a>
                          </div>
                        </div>
                      </div>
                    </div>
                     <?php } ?>
                    <tfoot>
                    <tr><th rowspan="1" colspan="1">ID</th><th rowspan="1" colspan="1">Nome</th><th rowspan="1" colspan="1">Preço</th>
