        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox ">
                    ...
                    $sql = "SELECT * FROM agendamento ORDER BY id ASC";
                    ...
                    foreach ($result as $linha) {
                     ...
                     ?>
                      <tr class="gradeX">
                        ...
                        <td><a href="altagendsecre.php?id=<?php echo $linha['id']; ?>" class="btn btn-info">Alterar</a></td>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            Deseja mesmo excluir o serviço <?php echo $linha['servicodesejado']; ?> de <?php echo $linha['nomecliente']; ?>?
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                            <a href="validaexclagend.php?id=<?php echo $linha['id']; ?>"><button type="button" class="btn btn-primary">Excluir</button></a>
                          </div>
                        </div>
                      </div>
                    </div>
