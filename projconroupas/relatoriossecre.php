...
<head>
    ...
    <title>Clothes Repair | Relatórios</title>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="cadcostugerente.php"><i class="glyphicon glyphicon-plus"></i> <span class="nav-label">Cadastro de Cliente</span></a>
                </li>
                <li>
                    <a href="consusecrecostugerente.php"><i class="glyphicon glyphicon-briefcase"></i> <span class="nav-label">Cadastro de Serviço</span></a>
                </li>
                <li>
