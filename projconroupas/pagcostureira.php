...
<head>
    ...
    <title>Clothes Repair | Home Costureira</title>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="text-muted text-xs block">Costureira <b class="caret"></b></span>
                        </a>
                ...
                <li class="active">
                    <a href="pagcostureira.php"><i class="glyphicon glyphicon-home"></i> <span class="nav-label">Serviços</span></a>  
                </li>
            </ul>
       ...
       <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox ">
                    ...
                    <thead>
                    <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="0" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 100px;">ID</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 150px;">Nome do Cliente</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 150px;">Serviço Desejado</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 150px;">Data de Início</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 150px;">Data de Entrega</th>
                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 150px;">Preço</th>
                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 150px;">Concluir</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php 
                    ...
                    $sql = "SELECT * FROM agendamento WHERE status='Pendente' ORDER BY id ASC";
                    ...
                    foreach ($result as $linha) {
                     ...
                     ?>
                      <tr class="gradeX">
                        ...
                        <td><?php echo $linha['servicodesejado']; ?></td>
                        <td><?php echo $linha['datainicio']; ?></td>
                        <td><?php echo $linha['dataentrega']; ?></td>
                        <td><?php echo $linha['preco']; ?></td>
                        <td><a href="validaconclusao.php?id=<?php echo $linha['id']; ?>" class="btn btn-info">Concluir</a></td>
                      
                    </tr>
                    </tbody>
                    <?php } ?>
                    <tfoot>
                    <tr><th rowspan="1" colspan="1">ID</th><th rowspan="1" colspan="1">Nome do Cliente</th><th rowspan="1" colspan="1">Serviço Desejado</th><th rowspan="1" colspan="1">Data de Início</th><th rowspan="1" colspan="1">Data de Entrega</th>
                        <th rowspan="1" colspan="1">Preço</th>
                        <th rowspan="1" colspan="1">Concluir</th>
                    </tr>
                    </tfoot>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox ">
                    ...
                    $sql = "SELECT * FROM agendamento WHERE status='concluido' ORDER BY id ASC";
