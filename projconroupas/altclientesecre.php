...
<head>
    ...
    <title>Clothes Repair | Cadastro de Cliente</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        <a href="altclientesecre.php"><i class="glyphicon glyphicon-pencil"></i> <span class="nav-label">Alterar Cliente</span></a>
                    </li>
                </ul>
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="ibox-content">
                ...
                ?>
                    <form method="post" action="validaaltcliente.php?id=<?php echo $resultado['id'] ?>">
                        ...
                        <div class="form-group  row"><label class="col-sm-1 col-form-label">Nome </label>
                            ...
                            <div class="col-sm-10"><input type="text" class="form-control" value="<?php echo $resultado['nome'] ?>" name="nomecliente"></div>
                        </div>
                        <div class="form-group row"><label class="col-sm-1 col-form-label">Telefone </label>
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-md-5"><input type="text" class="form-control" value="<?php echo $resultado['telefone'] ?>" name="telefone"></div>
                                    <div class="col-md-1"><label class="col-md-5 col-form-label">CPF </label></div>
                                    <div class="col-md-6"><input type="text" class="form-control" value="<?php echo $resultado['cpf'] ?>" name="cpf"></div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group  row"><label class="col-sm-1 col-form-label">Email </label>

                            <div class="col-sm-10"><input type="email" class="form-control" name="email" value="<?php echo $resultado['email'] ?>"></div>
                        </div>
                        <div class="col-sm-4">
